...
export const roles: Role[] = [
  ...
  },
  {
    ...
    period: '2011 to 2016',
    order: 4,
    work: 'genkey-biometric-identity',
  },
  {
    key: 'education',
...
export const sources: Source[] = [
  ...
  },
  {
    id: 'genkey',
    title: 'GenKey',
    url: 'https://www.genkey.com/about-us/',
    publisher: 'GenKey',
    date: '2016-01-01',
    role: 'genkey',
    kind: 'reference',
    note: 'Founded in 2001 out of a merger with priv-ID, a spin-out of the Philips biometrics research division. Headquartered in The Hague with an office in Accra, which is where I worked.',
  },
  {
    id: 'biometricupdate-ghana-elections',
    title: 'Biometrics use in Ghana elections matures',
    url: 'https://www.biometricupdate.com/202412/biometrics-use-in-ghana-elections-matures',
    publisher: 'Biometric Update',
    date: '2024-12-01',
    role: 'genkey',
    kind: 'press',
    note: 'Ghana first deployed biometrics in 2012 using a GenKey system, which was criticised for failures. By 2024, 18.3 million voters were biometrically verifiable, and officials fell back to facial verification where older voters could not be matched by fingerprint. The same failure mode, a decade later.',
  },
  {
    id: 'biometricupdate-genkey',
    title: 'GenKey company coverage',
    url: 'https://www.biometricupdate.com/companies/genkey',
    publisher: 'Biometric Update',
    date: '2016-01-01',
    role: 'genkey',
    kind: 'reference',
    note: 'Running coverage of GenKey deployments across elections and health insurance programmes.',
  },
  {
    id: 'nhis-biometric-authentication',
    title: 'NHIS biometric membership authentication',
    url: 'https://www.nhis.gov.gh/News/nhis-biometric-membership-authentication-system-limited-rollout-satisfactory-5582',
    publisher: 'National Health Insurance Authority, Ghana',
    date: '2018-01-01',
    role: 'genkey',
    kind: 'reference',
    note: 'Ghana biometrically authenticating insurance members at the point of care to cut claims fraud. The direct descendant of the problem ClaimSync was built to solve.',
  },
